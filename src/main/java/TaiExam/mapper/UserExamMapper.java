...
public interface UserExamMapper {
    List<UserExam> getUserInfoByExamId(int examId, int departmentId, int offset, int pageSize);
     ...
     */
    // 根据用户ID和关键字查询用户的所有问卷
    List<UserExam> getExamsByUserId(int userId, String keyword, int offset, int pageSize) ;
