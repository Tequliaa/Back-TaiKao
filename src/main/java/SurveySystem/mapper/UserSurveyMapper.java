...
public interface UserSurveyMapper {
    List<UserSurvey> getUserInfoBySurveyId(int surveyId, int departmentId, int offset, int pageSize);
     ...
     */
    // 根据用户ID和关键字查询用户的所有问卷
    List<UserSurvey> getSurveysByUserId(int userId, String keyword, int offset, int pageSize) ;
